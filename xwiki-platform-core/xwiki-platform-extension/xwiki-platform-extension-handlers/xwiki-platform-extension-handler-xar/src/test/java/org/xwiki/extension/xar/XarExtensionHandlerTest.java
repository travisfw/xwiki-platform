...
public class XarExtensionHandlerTest extends AbstractBridgedComponentTestCase
{
    ...
    public void testUpgradeOnWiki() throws Throwable
    {
        ...
        /*
         * XWikiDocument removedPage = this.mockXWiki.getDocument(new DocumentReference("wiki", "space1", "page1"),
         * getContext()); Assert.assertTrue("Document wiki.space1.page1 has not been removed from the database",
         * removedPage.isNew());
         */
    }
